...
int main(int argc, char *argv[])
{
        ...
        info_bar_contra = GTK_WIDGET(gtk_builder_get_object(builder, "info_bar_contra"));
        ...
        window_z = GTK_WIDGET(gtk_builder_get_object(builder, "window_z"));
        ...
        cb_user_arqueo = GTK_COMBO_BOX_TEXT(gtk_builder_get_object(builder, "cb_user_arqueo"));
        cb_user_corte = GTK_COMBO_BOX_TEXT(gtk_builder_get_object(builder, "cb_user_corte"));
        ...
        view_corte = GTK_WIDGET(gtk_builder_get_object(builder, "view_corte"));
        view_reporte = GTK_WIDGET(gtk_builder_get_object(builder, "view_reporte"));
        ...
        chk_faltante = GTK_WIDGET(gtk_builder_get_object(builder, "chk_faltante"));
        ...
        btn_aceptar_cz = GTK_BUTTON(gtk_builder_get_object(builder, "btn_aceptar_cz"));
        btn_vp = GTK_BUTTON(gtk_builder_get_object(builder, "btn_vp"));
        btn_pagar = GTK_BUTTON(gtk_builder_get_object(builder, "btn_pagar"));
        ...
        lbl_info_contra = GTK_LABEL(gtk_builder_get_object(builder, "lbl_info_contra"));
        ...
        lbl_user_ad = GTK_LABEL(gtk_builder_get_object(builder, "lbl_user_ad"));

        lbl_ventadia = GTK_LABEL(gtk_builder_get_object(builder, "lbl_ventadia"));
        lbl_clientes_dia = GTK_LABEL(gtk_builder_get_object(builder, "lbl_clientes_dia"));
        lbl_ventames = GTK_LABEL(gtk_builder_get_object(builder, "lbl_ventames"));
        lbl_ventames_min = GTK_LABEL(gtk_builder_get_object(builder, "lbl_ventames_min"));
        lbl_ventames_max = GTK_LABEL(gtk_builder_get_object(builder, "lbl_ventames_max"));
        lbl_ventaanio = GTK_LABEL(gtk_builder_get_object(builder, "lbl_ventaanio"));
        lbl_ventaanio_min = GTK_LABEL(gtk_builder_get_object(builder, "lbl_ventaanio_min"));
        lbl_ventaanio_max = GTK_LABEL(gtk_builder_get_object(builder, "lbl_ventaanio_max"));
        lbl_anio_ant = GTK_LABEL(gtk_builder_get_object(builder, "lbl_anio_ant"));
        ...
        window_password = GTK_WIDGET(gtk_builder_get_object(builder, "window_password"));
        ...
        reveal_x = GTK_WIDGET(gtk_builder_get_object(builder, "reveal_x"));
        reveal_z = GTK_WIDGET(gtk_builder_get_object(builder, "reveal_z"));
        ...
        btn_salir = GTK_BUTTON(gtk_builder_get_object(builder, "btn_salir"));
        btn_cambiar_cont = GTK_BUTTON(gtk_builder_get_object(builder, "btn_cambiar_cont"));
        btn_cancelar_contra = GTK_BUTTON(gtk_builder_get_object(builder, "btn_cancelar_contra"));
        btn_cambiar_contrasena = GTK_BUTTON(gtk_builder_get_object(builder, "btn_cambiar_contrasena"));

        btn_copia_producto = GTK_BUTTON(gtk_builder_get_object(builder, "btn_copia_producto"));
        ...
        ety_con_act = GTK_ENTRY(gtk_builder_get_object(builder, "ety_con_act"));
        ety_con_new = GTK_LABEL(gtk_builder_get_object(builder, "ety_con_new"));
        ety_con_new2 = GTK_ENTRY(gtk_builder_get_object(builder, "ety_con_new2"));
        ...
        lbl_arqueo = GTK_LABEL(gtk_builder_get_object(builder, "lbl_arqueo"));
        lbl_statusx = GTK_LABEL(gtk_builder_get_object(builder, "lbl_statusx"));
        lbl_statusz = GTK_LABEL(gtk_builder_get_object(builder, "lbl_statusz"));
        lbl_usuariocz = GTK_LABEL(gtk_builder_get_object(builder, "lbl_usuariocz"));
        lbl_corte = GTK_LABEL(gtk_builder_get_object(builder, "lbl_corte"));
        ...
        spin_cx = GTK_ENTRY(gtk_builder_get_object(builder, "spin_cx"));
        spin_cz = GTK_ENTRY(gtk_builder_get_object(builder, "spin_cz"));
        ...
        advertencia_cortez = GTK_WIDGET(gtk_builder_get_object(builder, "advertencia_cortez"));
        ...
        switch_inve = GTK_SWITCH(gtk_builder_get_object(builder, "switch_inve"));
        ...
        window_x = GTK_WIDGET(gtk_builder_get_object(builder, "window_x"));
        ...
        btn_elimina_inve = GTK_BUTTON(gtk_builder_get_object(builder, "btn_elimina_inve"));
        btn_corte = GTK_BUTTON(gtk_builder_get_object(builder, "btn_corte"));
        btn_x = GTK_BUTTON(gtk_builder_get_object(builder, "btn_x"));
        btn_exportaproductopdf = GTK_BUTTON(gtk_builder_get_object(builder, "btn_exportaproductopdf"));
        btn_arqueo = GTK_BUTTON(gtk_builder_get_object(builder, "btn_arqueo"));
        btn_eliminaticket = GTK_BUTTON(gtk_builder_get_object(builder, "btn_eliminaticket"));
        btn_cancelar_z = GTK_BUTTON(gtk_builder_get_object(builder, "btn_cancelar_z"));
        ...
        btn_z = GTK_BUTTON(gtk_builder_get_object(builder, "btn_z"));
        ...
        select4 = gtk_tree_view_get_selection(GTK_TREE_VIEW(view_inventario));
        gtk_tree_selection_set_mode(select4, GTK_SELECTION_SINGLE);
        select5 = gtk_tree_view_get_selection(GTK_TREE_VIEW(view_inventario_alt));
        gtk_tree_selection_set_mode(select5, GTK_SELECTION_SINGLE);
        select6 = gtk_tree_view_get_selection(GTK_TREE_VIEW(view_corte));
        gtk_tree_selection_set_mode(select6, GTK_SELECTION_SINGLE);
        ...
        g_signal_connect(G_OBJECT(window_z), "delete-event", G_CALLBACK(cierra_wz), NULL);
        ...
        g_signal_connect(G_OBJECT(advertencia_cortez), "delete-event", G_CALLBACK(cierra_advertenciaz), NULL);
        g_signal_connect(G_OBJECT(window_x), "delete-event", G_CALLBACK(oculta_arqueo), NULL);
        g_signal_connect(G_OBJECT(btn_Rein_Dial), "clicked", G_CALLBACK(on_btn_Rein_Dial_clicked), NULL);
        g_signal_connect(G_OBJECT(btn_z), "clicked", G_CALLBACK(abre_z), NULL);
        g_signal_connect(G_OBJECT(btn_arqueo), "clicked", G_CALLBACK(prs_arqueo), NULL);
        ...
        g_signal_connect(G_OBJECT(btn_corte), "clicked", G_CALLBACK(prs_corte), NULL);
        ...
        g_signal_connect(G_OBJECT(btn_cambiar_contrasena), "clicked", G_CALLBACK(abre_contrasena), NULL);
        g_signal_connect(G_OBJECT(btn_cambiar_cont), "clicked", G_CALLBACK(cambia_contrasena), NULL);
        ...
        g_signal_connect(G_OBJECT(btn_aceptar_cz), "clicked", G_CALLBACK(ingresa_cortez), NULL);
        ...
        g_signal_connect(G_OBJECT(btn_x), "clicked", G_CALLBACK(muestra_arqueo), NULL);
        g_signal_connect(G_OBJECT(btn_salir), "clicked", G_CALLBACK(on_Window_BD_destroy), NULL);
        ...
        g_signal_connect(G_OBJECT(btn_copia_producto), "clicked", G_CALLBACK(copia_articulo), NULL);
        ...
        g_signal_connect(G_OBJECT(btn_cancelar_z), "clicked", G_CALLBACK(cierra_advertenciaz), NULL);
        g_signal_connect(G_OBJECT(btn_pagar), "clicked", G_CALLBACK(pagar_faltante), NULL);
        g_signal_connect(G_OBJECT(btn_cancelar_contra), "clicked", G_CALLBACK(cierra_contrasena), NULL);
        g_signal_connect(G_OBJECT(window_password), "delete-event", G_CALLBACK(cierra_contrasena), NULL);
        ...
        g_signal_connect(G_OBJECT(select5), "changed", G_CALLBACK(select_query), NULL);
        g_signal_connect(G_OBJECT(select6), "changed", G_CALLBACK(selection_corte), NULL);

        g_signal_connect(G_OBJECT(ety_con_act), "changed", G_CALLBACK(comprueba_contrasena), NULL);
        g_signal_connect(G_OBJECT(ety_con_new), "changed", G_CALLBACK(comprueba_contrasena), NULL);
        g_signal_connect(G_OBJECT(ety_con_new2), "changed", G_CALLBACK(comprueba_contrasena), NULL);
        ...
        g_signal_connect(G_OBJECT(chk_faltante), "toggled", G_CALLBACK(filtra_faltante), NULL);
        /*
