...
void contenido_corte()
{
	conn = mysql_init(NULL);
	servidor();
	if (mysql_query(conn, "select * from Corte_z ORDER BY Id DESC"))
	{
	}
	res = mysql_use_result(conn);
	//==================================================================================================================
...
void contenido_reporte()
{
	conn = mysql_init(NULL);
	servidor();
	if (mysql_query(conn, "select * from Venta_total ORDER BY fecha DESC"))
	{
	}
	res = mysql_use_result(conn);
	//==================================================================================================================
