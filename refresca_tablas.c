...
void refresca_corte()
{
	...
	if (gtk_tree_model_get_iter_first(model_corte, &iter_corte) == TRUE)
	{
		gtk_list_store_clear(store_corte);
		gtk_tree_view_remove_column(GTK_TREE_VIEW(view_corte), column_corte);
		gtk_tree_view_remove_column(GTK_TREE_VIEW(view_corte), column_corte2);
		gtk_tree_view_remove_column(GTK_TREE_VIEW(view_corte), column_corte3);
		gtk_tree_view_remove_column(GTK_TREE_VIEW(view_corte), column_corte4);
		gtk_tree_view_remove_column(GTK_TREE_VIEW(view_corte), column_corte5);
		gtk_tree_view_remove_column(GTK_TREE_VIEW(view_corte), column_corte6);
		gtk_tree_view_remove_column(GTK_TREE_VIEW(view_corte), column_corte7);
		gtk_tree_view_remove_column(GTK_TREE_VIEW(view_corte), column_corte8);
	}
}

void refresca_reporte()
{

	if (gtk_tree_model_get_iter_first(model_reporte, &iter_reporte) == TRUE)
	{
		gtk_list_store_clear(store_reporte);
		gtk_tree_view_remove_column(GTK_TREE_VIEW(view_reporte), column_repor);
		gtk_tree_view_remove_column(GTK_TREE_VIEW(view_reporte), column_repor2);
	}
}
...
void refresca_inve()
{
	...
	if (gtk_tree_model_get_iter_first(model_inventario, &iter_inventario) == TRUE)
	{
		...
		gtk_tree_view_remove_column(GTK_TREE_VIEW(view_inventario), column_inve6);
	}
}

void refresca_inve_alt()
{

	if (gtk_tree_model_get_iter_first(model_inventario_alt, &iter_inventario_alt) == TRUE)
	{
		gtk_list_store_clear(store_inve_alt);
		gtk_tree_view_remove_column(GTK_TREE_VIEW(view_inventario_alt), column_inve_alt);
		gtk_tree_view_remove_column(GTK_TREE_VIEW(view_inventario_alt), column_inve_alt2);
		gtk_tree_view_remove_column(GTK_TREE_VIEW(view_inventario_alt), column_inve_alt3);
		gtk_tree_view_remove_column(GTK_TREE_VIEW(view_inventario_alt), column_inve_alt4);
		gtk_tree_view_remove_column(GTK_TREE_VIEW(view_inventario_alt), column_inve_alt5);
	}
}

void refresca_inve_desc()
{

	if (gtk_tree_model_get_iter_first(model_inventario_desc, &iter_inventario_desc) == TRUE)
	{
		gtk_list_store_clear(store_inve_desc);
		gtk_tree_view_remove_column(GTK_TREE_VIEW(view_descinve), column_inve_desc);
		gtk_tree_view_remove_column(GTK_TREE_VIEW(view_descinve), column_inve_desc0);
		gtk_tree_view_remove_column(GTK_TREE_VIEW(view_descinve), column_inve_desc2);
		gtk_tree_view_remove_column(GTK_TREE_VIEW(view_descinve), column_inve_desc3);
		gtk_tree_view_remove_column(GTK_TREE_VIEW(view_descinve), column_inve_desc4);
		gtk_tree_view_remove_column(GTK_TREE_VIEW(view_descinve), column_inve_desc5);
		gtk_tree_view_remove_column(GTK_TREE_VIEW(view_descinve), column_inve_desc6);
	}
}
void refresca_venta()
{
