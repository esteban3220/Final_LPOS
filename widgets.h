...
GtkEntry            *spin_cz;
GtkEntry            *ety_con_act;
GtkEntry            *ety_con_new;
GtkEntry            *ety_con_new2;
GtkLabel			*ety_cambio;
GtkLabel            *lbl_inventario;

GtkLabel            *lbl_ventadia;
GtkLabel            *lbl_clientes_dia;
GtkLabel            *lbl_ventames;
GtkLabel            *lbl_ventames_min;
GtkLabel            *lbl_ventames_max;
GtkLabel            *lbl_ventaanio;
GtkLabel            *lbl_ventaanio_min;
GtkLabel            *lbl_ventaanio_max;
...
GtkComboBoxText     *cb_user_arqueo;
...
GtkButton           *btn_cancelar_contra;
GtkButton           *btn_cambiar_cont;
GtkButton           *btn_cambiar_contrasena;
...
GtkLabel            *lbl_arqueo;
GtkLabel            *lbl_corte;
GtkLabel            *lbl_usuariocz;
GtkWidget           *cancelar_elemento;
GtkWidget           *window_vp;
GtkWidget           *window_x;
GtkWidget           *reveal_x;
GtkWidget           *reveal_z;
GtkWidget           *advertencia_cortez;
GtkButton			*btn_resetfrcha;
GtkButton           *btn_elimina_vp;
GtkButton           *btn_cancelar_z;
GtkButton           *btn_aceptar_cz;
GtkButton           *btn_vp;
GtkButton           *btn_arqueo;
GtkButton           *btn_x;
...
GtkLabel            *lbl_statusx;
GtkLabel            *lbl_articulo_vp1;
GtkLabel            *lbl_corte;
GtkLabel            *lbl_statusz;
GtkLabel            *lbl_anio_ant;
...
GtkTreeIter   	 	iter_corte;
GtkTreeIter   	 	iter_reporte;
...
GtkCellRenderer     *renderer_corte;
GtkCellRenderer     *renderer_reporte;
...
GtkTreeModel        *model_corte;
GtkTreeModel        *model_reporte;
GtkTreeModel        *model2;
GtkTreeModel        *model3;
GtkTreeModel        *model4;
GtkTreeModel        *model5;
...
GtkListStore  		*store_corte;
GtkListStore  		*store_reporte;
...
GtkTreeViewColumn 	*column_repor;
GtkTreeViewColumn 	*column_repor2;
...
GtkTreeViewColumn 	*column_corte;
GtkTreeViewColumn 	*column_corte2;
GtkTreeViewColumn 	*column_corte3;
GtkTreeViewColumn 	*column_corte4;
GtkTreeViewColumn 	*column_corte5;
GtkTreeViewColumn 	*column_corte6;
GtkTreeViewColumn 	*column_corte7;
GtkTreeViewColumn 	*column_corte8;
